...
const dataLine1 = {
  ...
  datasets: [{
    ...
    data: [14, 20, 12, 20, 19, 23], // Datos de los km recorridos en cada día
...
const dataLine2 = {
  ...
  datasets: [{
    ...
    data: [16, 17, 12, 9, 16, 20], // Datos de los km recorridos en cada día    borderColor: 'rgba(153, 102, 255, 1)',
    fill: true,
    tension: 0.1
  }]
};

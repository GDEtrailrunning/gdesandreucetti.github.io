...
const dataLine1 = {
  ...
  datasets: [{
    ...
    data: [12, 15, 12, 14, 16, 25], // Datos de los km recorridos en cada día
...
const dataLine2 = {
  ...
  datasets: [{
    ...
    data: [14, 23, 14, 5, 14, 30], // Datos de los km recorridos en cada día    borderColor: 'rgba(153, 102, 255, 1)',
    fill: true,
    tension: 0.1
  }]
};

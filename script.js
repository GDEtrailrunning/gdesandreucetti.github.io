...
const dataLine1 = {
  ...
  datasets: [{
    ...
    data: [11, 15, 16, 19, 15, 25], // Datos de los km recorridos en cada día
...
const dataLine2 = {
  ...
  datasets: [{
    ...
    data: [14, 13, 19, 13, 13, 25], // Datos de los km recorridos en cada día    borderColor: 'rgba(153, 102, 255, 1)',
    fill: true,
    tension: 0.1
  }]
};
